...
/**
 * The destination class for events in the system. The current implementation
 * displays the events in a modal popup window.
 */
//==============================================================
public class Event {
     ...
     * parameter points in the description. A typical description example is as
     * follows:
     *
     * "Failed to find file <0> in directory <1>".
     *
     * <0> and <1> are the two parameter points to be replaced by actual strings
     * - typically <0> will be replaced by a file name and <1> by a directory
     * name.
     *
     * This variable contains a comma-separated string with these actual
     * parameters
     */
    String myParams;
     ...
     * @param	name	Name of method in which event occurred
     *
     * @param	tag	Tag used to refer to the Internationalized message description
     * - which is pulled from the messages bundle
     *
     * @param	description	Plain English description of event details
     *
     * @param	severity	Ordinal severity level for event
     ...
     * - which is pulled from the messages bundle
     *
     * @param	params	String which is a comma-separated list of parameters to
     * fill in the parameter points in the internationalized description tag
     * with
     *
     * @param	description	Plain English description of event details
     *
     * @param	severity	Ordinal severity level for event
     *
     * @param	sync	boolean indicating whether the event is synchronous or
     * asynchronous
     *
     */
    //----------------------------------------------------------
    ...
    /**
     * Provide a complete displayable version of the Event. Note that this
     * format is parsed by EventLogModel.parseEvent() which will need to be
     * changed if this format is modified
     *
     * @return	String value providing a displayable form of the event in a
     * format which can be seen by looking at the code
     */
    //----------------------------------------------------------
    ...
    /**
     * Returns a string containing the date and time of this event in US date
     * format
     *
     * @return String object containing the date and time of this event in US
     * date format
     */
    //----------------------------------------------------------
