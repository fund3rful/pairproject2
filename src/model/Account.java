...
public class Account extends EntityBase implements IView {
    ...
    /**
     * Credit balance (Method is public because it may be invoked directly as it
     * has no possibility of callback associated with it)
     */
    //----------------------------------------------------------
    ...
    /**
     * Debit balance (Method is public because it may be invoked directly as it
     * has no possibility of callback associated with it)
     */
    //----------------------------------------------------------
    ...
    /**
     * Check balance -- returns true/false depending on whether there is enough
     * balance to cover withdrawalAmount or not (Method is public because it may
     * be invoked directly as it has no possibility of callback associated with
     * it)
     *
     */
    //----------------------------------------------------------
