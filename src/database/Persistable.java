...
//			DEBUG: System.err.println( "An SQL Error Occured:" + sqle + "\n" + sqle.getErrorCode() + "\n" + sqle.getMessage() + "\n" + sqle);
    ...
    /**
     * Create and execute a SQL statement to extract the required fields from
     * the database. Returns a Vector with each element being a Properties
     * object containing the columnName=columnValue mappings
     */
    //------------------------------------------------------------
...
//			DEBUG: 
     ...
     * extract the required fields from the database. Returns a Vector with each
     * element being a Properties object containing the columnName=columnValue
     * mappings
     */
    //------------------------------------------------------------
...
//			DEBUG: System.err.println( "An SQL Error Occurred:" + sqle + "\n" + sqle.getErrorCode() + "\n" + sqle.getMessage() + "\n" + sqle);
    ...
    /**
     * Create and execute a SQL statement to extract the required fields from
     * the database. Returns an int indicating the return code from SQL UPDATE
     * statement
     */
    //------------------------------------------------------------
...
//			DEBUG: 
     ...
     * database. Returns an int indicating the auto-incremental id from SQL
     * INSERT statement
     */
    //------------------------------------------------------------
...
//			DEBUG: System.err.println( "Persistable.insertAutoIncrementalPersistentState: An SQL Error Occurred: SQL State: " + sqle.getSQLState() + "; Error Code = " + sqle.getErrorCode() + "; Message: " + sqle.getMessage() + "\n" + sqle);
    ...
    /**
     * Create and execute a SQL statement to insert the required fields into the
     * database. Returns an int indicating the return code from SQL INSERT
     * statement
     */
    //------------------------------------------------------------
...
//			DEBUG: 
    ...
    /**
     * Create and execture a SQL statement to delete the required fields from
     * the database. Returns an integer indicating the return code from SQL
     * DELETE statement
     */
    //------------------------------------------------------------
