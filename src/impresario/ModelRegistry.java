...
public class ModelRegistry extends Registry {
    ...
    /**
     * This is the method that actually checks the dependency file for the key
     * on which the state change was posted, finds out which keys depend on this
     * key, and then invokes the update methods on all the Views that subscribe
     * to each dependant key. The value sent to the View comes from this object.
