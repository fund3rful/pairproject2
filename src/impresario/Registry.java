...
public abstract class Registry {
    ...
    /**
     * Method that is used to associate (subscribe) a particular object (Model,
     * View) to a key. After this method executes, the Registry object knows
     * that the subscriber object is associated with the key, and when an update
     * to the key must be invoked, the subscriber object is one of the actual
     * objects whose update method must be called
     *
     * @param	key	String indicating key to which the subscriber object wants to
     * subscribe
     *
