...
// local imports
/**
 * This class handles a string which contains embedded strings. The enumeration
 * interface is implemented to provide access to string elements.	The tokens are
 * assumed to be separated by commas (no spaces).
 */
//--------------------------------------------------------------
public class StringList
     ...
     *
     * @param	str	The comma-separated String to convert to an object of this
     * type
     */
    //----------------------------------------------------------
     ...
     *
     * @return	boolean value indicating whether there are more elements in the
     * list (or not)
     */
    //----------------------------------------------------------
